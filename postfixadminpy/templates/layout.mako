...
<html lang="${request.locale_name}">
  <head>
    ...
    <link rel="shortcut icon" href="${h.static('css/pyramid-16x16.png')}">
    ...
    <link href="${h.static('css/theme.css')}" rel="stylesheet">
  ...
  <body>
    ...
    <div class="starter-template">
      <div class="container">
        <div class="row">
          <div class="col-md-2">
              <img class="logo img-responsive" src="${h.static('images/pyramid.png')}" alt="pyramid web framework">
          </div>
          <div class="col-md-10">
            {% block content %}
                <p>No content</p>
